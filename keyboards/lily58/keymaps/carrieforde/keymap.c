...
enum custom_keycodes { QWERTY = SAFE_RANGE, LOWER, RAISE, AUTOSHIFT };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |      |      |  MUp |      |      |      |                    |      | ASDN | ASUP | ASRP |      |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |      | MLeft| MDown|MRight|      |      |-------.    ,-------|      | ASON |ASOFF | ASTG |      |      |
     * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
     * |      |      |      |      |      |      |-------|    |-------|      |      |      |     |      |  \   |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *                   |      |      |      | /       /       \      \  |      |      |      |
     ...
     *                   `----------------------------'           '------''--------------------'
     */
    [_AUTOSHIFT] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_ASDN, KC_ASUP, KC_ASRP, _______, _______, _______, _______, KC_UP, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, KC_ASON, KC_ASOFF, KC_ASTG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______)};
